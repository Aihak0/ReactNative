...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($_FILES['fileFoto']['tmp_name'], $targetFile)) {
        ...
        $sql = "INSERT INTO foto (JudulFoto, TanggalUnggah, DeskripsiFoto, AlbumID, UserID, LokasiFile) VALUES ('$JudulFoto', '$TanggalUnggah', '$DeskripsiFoto', '$AlbumID', '$UserID', '$targetFile')";

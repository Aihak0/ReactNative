...
if(isset($_POST['Email'])){
    ...
    $mail->Body    = 'Please click the following link to verify your email: <a href="http://localhost/GALERY-VITE/api/verify.php?email=' . urlencode($email) . '&token='. $token .'">Verify Email</a>';
